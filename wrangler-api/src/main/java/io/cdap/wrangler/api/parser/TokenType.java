...
public enum TokenType implements Serializable {
   ...
   * This type is associated with token that parses data sizes such as 10KB, 1.5MB etc.
   */
  BYTE_SIZE,

  /**
   * Represents the enumerated type for the object of type {@code TimeDuration} type.
   * This type is associated with token that parses time durations like 10ms, 2.5s, etc.
   */
  TIME_DURATION
